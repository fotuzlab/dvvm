...
class DiffEngine {
   ...
   */
  protected function _ddv($xoff, $xlim, $yoff, $ylim, $nchunks) {
    $flip = FALSE;
  ...
  protected function _compareseq($xoff, $xlim, $yoff, $ylim) {
    ...
    // Slide down the bottom initial ddvonal.
    while ($xoff < $xlim && $yoff < $ylim && $this->xv[$xoff] == $this->yv[$yoff]) {
      ++$xoff;
      ++$yoff;
    }

    // Slide up the top initial ddvonal.
    ...
    if ($xoff == $xlim || $yoff == $ylim) {
      ...
      list($lcs, $seps) = $this->_ddv($xoff, $xlim, $yoff, $ylim, $nchunks);
    }
